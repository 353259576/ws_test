...
public class TestController {
    ...
    public static void main(String[] args) {
        ...
        SQLModelUtils sqlModelUtils = new SQLModelUtils(MySearchList.create(User.class).eq(User::getUserId,1));
        InsertSqlEntity insertSqlEntity = sqlModelUtils.insertSql(user);
        System.out.println(insertSqlEntity.getInsertSql());
        insertSqlEntity = sqlModelUtils.insertSqlBatch(Arrays.asList(user));
        System.out.println(insertSqlEntity.getInsertSql());
